...
csv_files = [
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_linear_regression_DJA.csv",
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_linear_regression_GSPC.csv",
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_linear_regression_IXIC.csv",
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_linear_regression_NYA.csv"
]

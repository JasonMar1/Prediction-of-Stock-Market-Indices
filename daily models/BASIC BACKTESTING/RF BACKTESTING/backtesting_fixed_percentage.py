...
csv_files = [
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_random_forest_DJA.csv",
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_random_forest_GSPC.csv",
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_random_forest_IXIC.csv",
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_random_forest_NYA.csv"
]

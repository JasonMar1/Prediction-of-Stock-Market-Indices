...
csv_files = [
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_svr_DJA.csv",
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_svr_GSPC.csv",
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_svr_IXIC.csv",
    "../../BASIC ML DAILY PREDICTIONS BEST/predictions_svr_NYA.csv"
]

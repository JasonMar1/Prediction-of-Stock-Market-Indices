...
def conditional_lstm_load_monthly_data(selected_index, standardized, TRAIN_START_DATE, TRAIN_END_DATE, VALID_START_DATE, VALID_END_DATE, TEST_START_DATE, TEST_END_DATE):
...
def conditional_lstm_load_multiple_indices(type, standardized, TRAIN_START_DATE, TRAIN_END_DATE, VALID_START_DATE, VALID_END_DATE, TEST_START_DATE, TEST_END_DATE):
    ...
    for index_name in selected_indices.values():
        ...
        if type == 'daily':
            ...
            X_train, y_train, X_valid, y_valid, X_test, y_test, df_train, df_valid, df_test, features = conditional_lstm_load_monthly_data(index_name, standardized, TRAIN_START_DATE, TRAIN_END_DATE, VALID_START_DATE, VALID_END_DATE, TEST_START_DATE, TEST_END_DATE)

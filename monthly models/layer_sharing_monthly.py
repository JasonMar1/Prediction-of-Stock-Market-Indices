...
dropout = 0.4
learning_rate = 0.00012156132257732844
batch_size = 80
...
scheduler = optim.lr_scheduler.OneCycleLR(
    optimizer,
    max_lr=0.01578272470013608,
    steps_per_epoch=len(train_loader),
    epochs=epochs,
    pct_start=0.15192470389950052,
    anneal_strategy='cos',
    div_factor=24,
    final_div_factor=413,
)
...
results_filtered.to_csv("monthly_predictions_layer_sharing.csv")